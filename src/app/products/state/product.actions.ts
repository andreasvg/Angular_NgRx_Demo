...
// Define all of our actions for the Product feature in an enum:
export enum ProductActionTypes {
  ...
  LoadFail = '[Product] Load Products Error',
...
// Create a type to union all of our action creators (this new type represents all of the possible creators for Product actions):
